...
public class PatronController {
    ...
    @GetMapping("/patrons/{patron_id}/checkouts")
    ...
    @GetMapping("/patrons/{patron_id}/extended_attributes")
    ...
    @PostMapping("/patrons/{patron_id}/extended_attributes")
    ...
    @PutMapping("/patrons/{patron_id}/extended_attributes")
    ...
    @PutMapping("/patrons/{patron_id}/extended_attributes/{extended_attribute_id}")
    ...
    @DeleteMapping("/patrons/{patron_id}/extended_attributes/{extended_attribute_id}")
    ...
    @GetMapping("/patrons/{patron_id}/holds")
    ...
    @GetMapping("/patrons/{patron_id}/hold_groups")
    ...
    @PostMapping("/patrons/{patron_id}/hold_groups")
    ...
    @DeleteMapping("/patrons/{patron_id}/hold_groups/{hold_group_id}")
    ...
    @PostMapping("/patrons/{patron_id}/hold_groups/{hold_group_id}/cancel")
    ...
    @PutMapping("/patrons/{patron_id}/password")
    ...
    @PutMapping("/patrons/{patron_id}/password/expiration_date")
    ...
    @GetMapping("/patrons/{patron_id}/recalls")
    ...
    // ── /clubs/{club_id}/holds ──
    @PostMapping("/clubs/{club_id}/holds")
    ...
    @PutMapping("/public/patrons/{patron_id}/password")
    ...
    @PostMapping("/public/patrons/{patron_id}/checkouts")
    ...
    @PutMapping("/public/patrons/{patron_id}/guarantors/can_see_charges")
    ...
    @PutMapping("/public/patrons/{patron_id}/guarantors/can_see_checkouts")
    ...
    @DeleteMapping("/public/patrons/{patron_id}/holds/{hold_id}")
    ...
    @GetMapping("/public/patrons/{patron_id}/ill/requests")
